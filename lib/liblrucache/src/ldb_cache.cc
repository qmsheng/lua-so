...
// ====== begin ==============================
// 2015-08-25 jiang z.s. 
// 获取当前已经使用的cache容量
size_t leveldb_get_size(leveldb_cache_t *lcache)
{
    return lcache->rep->getSize();
}

// 获取当前cache的最大容量
size_t leveldb_get_capacity(leveldb_cache_t *lcache)
{
    return lcache->rep->getCapacity();
}
